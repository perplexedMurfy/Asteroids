...
const SDL_Point UFOPointsSmall[] = {{-4, -4}, {4, -4}, {2, -8}, {-2, -8}, {-4, -4},
    {-6, 0}, {6, 0}, {4, -4}, {6, 0},
    {2, 4}, {-2, 4}, {-6, 0}};
const v2Pair UFOColsSmall[] = {{{-4, -4},{-2, -8}}, {{-2, -8},{2, -8}}, {{2, -8},{4, -4}}, {{4, -4},{6, 0}}, {{6, 0},{2, 4}}, {{2, 4},{-2, 4}}, {{-2, 4},{-6, 0}}, {{-6, 0},{-4, -4}}};

const SDL_Point UFOPointsBig[] = {{-8, -8}, {8, -8}, {4, -12}, {-4, -12}, {-8, -8},
    {-12, 0}, {12, 0}, {8, -8}, {12, 0},
    {4, 8}, {-4, 8}, {-12, 0}};
const v2Pair UFOColsBig[] = {{{-8, -8},{-4, -12}}, {{-4, -12},{4, -12}}, {{4, -12},{8, -8}}, {{8, -8},{12, 0}}, {{12, 0},{4, 8}}, {{4, 8},{-4, 8}}, {{-4, 8},{-12, 0}}, {{-12, 0},{-8, -8}}};
